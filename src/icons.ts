...
export { default as DashboardOutline } from '@ant-design/icons-svg/lib/outline/DashboardOutline';
export { default as TransactionOutline } from '@ant-design/icons-svg/lib/outline/TransactionOutline';
