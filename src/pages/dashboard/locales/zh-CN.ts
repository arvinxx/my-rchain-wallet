export default {
  ...
  'dashboard.account.balance.deploy': '重新部署合约',
  'dashboard.account.balance.default': '开始部署合约...',
  'dashboard.account.balance.processing': '等待出块...',
  'dashboard.account.balance.processing.block': '(已出{number}块)',
  'dashboard.account.balance.success': '部署成功',
  'dashboard.account.balance.error': '合约部署失败,请稍后重试',
