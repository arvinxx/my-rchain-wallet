export default {
  ...
  'account.components.network.title.mainnet': '主网',
  ...
  'account.components.network.form.observer': '只读节点地址',
  'account.components.network.form.validator': '验证者节点地址',
  'account.components.network.form.reset': '重置',
  'account.components.network.form.save': '保存',
